...
`,
  },
  {
    ...
    description:
      "Implement a function to filter out negative numbers from an array",
    code: `
...
`,
  },
  {
    ...
    name: "Sum Array",
    description:
      "Implement a function to calculate the sum of all elements in an array",
    code: `
